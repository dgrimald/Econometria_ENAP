...
O exemplo de hoje é inspirado em [\textit{Cheng, Cheng, and Mark Hoekstra. 2013. “Does Strengthening Self-Defense Law Deter Crime or Escalate Violence? Evidence from Expansions to Castle Doctrine.” Journal of Human Resources.
...
\begin{align}
S_{it} &= \frac{1}{1+e^{\alpha_{it}}} \\
P_{it} &= \begin{cases}
0; \; B(T, s_{it})<\frac{T}{2} \\
1; \; B(T, s_{it})>=\frac{T}{2}
\end{cases}
\end{align}

$P_{it}$ assume valores 0 ou 1, a dependender da realização de uma binomial cuja probabilidade de sucesso é dada por $S_{it}$ e $T$ (total de períodos dentro do painel). **Por simplificação, todos os indivíduos que têm acesso à política, começam a receber o tratamento no mesmo período $t_p=\frac{T}{2}+1$.**

## Implementando PGD

Como de costume, escrevemos uma [função]() para simular esse PGD
